    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-sky-50 to-indigo-50 p-4">
      <Card className="w-full max-w-md shadow-lg border border-gray-200">
        <CardHeader className="space-y-1 text-center pb-6">
          ...
          <CardTitle className="text-2xl font-semibold text-slate-800">Create a new account</CardTitle>
        ...
        <CardContent>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <Button
                type="submit"
                className="w-full py-3 rounded-lg bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold shadow-md transition-all duration-200 transform hover:scale-[1.02] cursor-pointer"
                disabled={isLoading}
              >
                {isLoading ? (
      ...
      {/* add github and goole option in future */}
